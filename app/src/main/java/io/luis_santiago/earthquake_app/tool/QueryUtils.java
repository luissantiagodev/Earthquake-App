...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> fetchDataEarthquake() {
        ArrayList<Earthquake> carl;
    ...
    private static String readStreamFrom(InputStream inputStream) throws IOException {
    ...
    public static ArrayList extractEarthquakeData(String earthquakeJSON) {
